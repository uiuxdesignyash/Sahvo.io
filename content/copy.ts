...
export const COPY = {
  ...
  trustGap: {
    ...
    evidenceCards: [
      ...
      {
        id: 'overcharge',
        title: 'Autorickshaw overcharge multiple reaches 25x the metered rate.',
        body: 'Tour operators in Jaipur report typical drivers charging 25 times the official metered fare during tourist seasons.',
        source: 'IITTM study for the Ministry of Tourism',
        year: '2022',
        isPlaceholder: false,
      },
      {
        ...
        body: 'Ministry of Tourism data shows gap between registered tourist guides and those operating without official certification.',
        source: 'Rajasthan Department of Tourism',
        year: '2025',
        isPlaceholder: false,
      },
